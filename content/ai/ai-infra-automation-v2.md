...
구조는 단순해졌고, 누구나 채널에 글만 쓰면 에이전트가 반응하게 됐다. 하지만 새로운 질문이 생겼다. 이 시스템을 팀 전체가 함께 사용하려면 어떻게 해야 하는가? 같은 AI 에이전트에게 팀의 경험을 쌓고, 누가 요청하든 균일한 응답 수준을 유지하는 문제다. [다음 편](/ai/ai-infra-automation-v3/)에서는 이 고민을 다룬다.
